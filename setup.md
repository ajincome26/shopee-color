...
```bash
npm i sass react-toastify react-icons lodash @floating-ui/react framer-motion uuid react-hook-form yup @hookform/resolvers classnames dompurify slugify immer
