    ...
    <div className='bg-[#f5f5f5]'>
      <footer className='container'>
        <div className='grid grid-cols-1 gap-5 py-8 text-center md:grid-cols-3 lg:grid-cols-5'>
          <div className=''>
            <h3 className='mb-3 font-semibold uppercase'>Chăm sóc khách hàng</h3>
            {footerTakeCare.map(({ id, text }) => (
              <div key={id} className='text-sm text-grayDark'>
                {text}
              </div>
            ))}
          </div>
          ...
          <div className=''>
            <h3 className='mb-3 font-semibold uppercase'>Về Shopee Color</h3>
          ...
          <div className=''>
            ...
            <div className='grid grid-cols-2 gap-2 w-[70%] md:w-full md:grid-cols-3 mx-auto'>
          ...
          <div className=''>
            ...
            <div className='flex items-center justify-center gap-3 lg:items-start md:flex-col'>
              {footerSocial.map(({ id, text, icon: Icon, link }) => (
                <Link to={link} key={id} className='flex items-center gap-2'>
                  <Icon className='text-secondary' />
                  <div className='text-sm transition text-grayDark hover:text-primary'>{text}</div>
                </Link>
              ))}
            </div>
          </div>
        ...
        <div className='py-5 text-center text-grayDark'>
