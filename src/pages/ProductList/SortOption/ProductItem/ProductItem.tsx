    ...
    >
      ...
      <div className='p-2'>
        ...
        <div className='flex items-center gap-4 mt-[10px] xl:gap-2 2xl:gap-1'>
          ...
          <span className='text-sm md:text-xs text-primary xl:text-sm 2xl:text-base'>₫{formatCurrency(price)}</span>
        </div>
        <div className='flex items-center justify-between gap-4 mt-2 md:gap-2'>
