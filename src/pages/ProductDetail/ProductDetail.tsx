...
const ProductDetail = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>{product.name} | Shopee Color</title>
                          ...
                          popover={
                            <>
                              ...
                              <span className='leading-6'>
                                Nội dung chương trình: Chương trình mang đến cho Người mua những sản phẩm có giá tốt
                                nhất so với các sản phẩm cùng loại được bán trên sàn. Sản phẩm tham gia chương trình sẽ
                                được gắn nhãn "Gì Cũng Giảm" trên trang mua hàng của chúng tôi.
                              </span>
                            </>
                          }
                        >
